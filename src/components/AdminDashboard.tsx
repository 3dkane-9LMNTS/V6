...
const pieData = [
  { name: 'Sound Clash', value: 35, color: '#00D4FF' },
  { name: 'Wedding OS', value: 25, color: '#10B981' },
  { name: 'Corporate', value: 20, color: '#2A3441' },
  { name: 'AI Element', value: 20, color: '#FF7A00' },
];
